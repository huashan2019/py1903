...
**  Return      : BOOL
********************************************************************************/
void FTM0_PWM_Init(void)////CCFL±³¹âPWM
{
    ...
    FTM_ClockSet(FTM0, FTM_CLOCK_SYSTEMCLOCK, FTM_CLOCK_PS_DIV16);  
    FTM_SetModValue(FTM0, 5000);///40M/16/5000 = 500
	FTM_SetChannelValue(FTM0, FTM_CHANNEL_CHANNEL0, 3750);///Õ¼¿Õ±È  =  3750/5000
}
