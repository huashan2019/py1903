...
void Bt_ACK(SCH_U8 ack_type)
{
	...
	buf[1] = 'T';
	buf[2] = '>';
	buf[3] = 0x01;/*DATA TYPE:0X0102 SPP数据，0x0101 BLE数据*/
...
void M2B_TxService(void)
{
	...
	BtTxModuel.TxData[2] = '>';
	BtTxModuel.TxData[3] = 0x01;/*DATA TYPE:0X0102 SPP数据，0x0101 BLE数据*/
	...
	BtTxModuel.TxData[5] = 0x00;/*length H:从0x80开始，0x0d结束*/
